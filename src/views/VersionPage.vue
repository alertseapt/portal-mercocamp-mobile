  ...
  <div class="version-page">
    ...
    <div v-else class="version-content">
      ...
      <div class="release-notes">
        ...
        <!-- Melhorias -->
        <div
          v-if="currentVersionData.improvements?.length"
          class="notes-section"
        >
          <h3 class="section-title">
            ...
            >
              ...
              <div class="note-content">
                ...
                <div v-if="improvement.details" class="note-details">
                  <ul>
                    <li v-for="detail in improvement.details" :key="detail">
                      {{ detail }}
                    </li>
                  </ul>
                </div>
            ...
            >
              ...
              <div class="note-content">
                ...
                <div v-if="bugfix.details" class="note-details">
                  <ul>
                    <li v-for="detail in bugfix.details" :key="detail">
                      {{ detail }}
                    </li>
                  </ul>
                </div>
        ...
        <div v-if="currentVersionData.breaking?.length" class="notes-section">
          ...
          <div class="alert-warning">
            ...
            <strong>Atenção:</strong> Esta versão contém alterações que podem
...
export default {
  ...
  computed: {
    currentVersionData() {
      return (
        this.versions.find(v => v.number === this.selectedVersion) ||
        this.versions[0]
      )
    },
  },
