            ...
            <div class="row align-items-center">
              <div class="col">
                <p class="mb-1 text-dark">
                  ...
                  <span class="ms-2 text-monospace text-primary fw-bold">{{
                    searchValue
                  }}</span>
                </p>
              </div>
                  ...
                  <div class="row text-sm">
                    <div class="col-md-6 mb-2">
                      <div class="info-item">
                        ...
                        <span class="ms-2">{{
                          schedule.client_info?.name || schedule.client
                        }}</span>
                      </div>
                    </div>
                    <div class="col-md-6 mb-2">
...
.status-badge {
  ...
  padding: calc(0.5rem * var(--status-badge-scale))
    calc(1rem * var(--status-badge-scale));
  border-radius: calc(20px * var(--status-badge-scale));
  font-weight: 500;
